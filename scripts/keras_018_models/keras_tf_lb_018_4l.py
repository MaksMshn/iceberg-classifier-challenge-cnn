...
def create_dataset(frame,
    ...
    band_4 = gray_reshape(band_4)

    #images = tf_reshape(images)
    band = np.stack([band_1, band_2, band_3, band_4], axis=3)
    if labeled:
...
submission.to_csv("../submit/keras_018_4l_model.csv", index=False)
